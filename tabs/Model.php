...
<body>
    ...
    $r = mysqli_query(
        ...
        "SELECT idModel, NaimenModel, NaimenMark 
         FROM model   
         JOIN mark ON Mark_idMark = mark.idMark 
    ...
    do {
        echo "<tr>";
        echo "<form class='form-table' action='../mods/update/Model.php' method='post'>";
        echo "<td><input size='1' class='form-control' name='idModel' type='text' value='$myrow[idModel]' readonly='readonly'/></td>";
        echo "<td><input size='15' class='form-control' name='NaimenModel' type='text' value='$myrow[NaimenModel]' required/></td>";
        echo "<td><input size='5' class='form-control' name='Mark_idMark' type='text' value='$myrow[NaimenMark]' readonly='readonly'/></td>";
